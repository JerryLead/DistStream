...
public class WithKmeans extends AbstractClusterer {
    ...
    public int mergeMic = 0;
    public int deleteMic = 0;


    public Long initalTime = 0L;
    ...
    public void setMergeMic(int num){
        this.mergeMic = num;
    }
    public void setDeleteMic(int num){
        this.deleteMic = num;
    }
    ...
    public void initialOstr(Instance instance){
        Long t0 = System.currentTimeMillis();
        dim = instance.numValues();
    ...
    public void initialClustream(){
        Long t0 = System.currentTimeMillis();
        for (int i = 0; i < buffer.size(); i++) {
            long tmpStamp = 0;
            kernels[i] = new ClustreamKernel(new DenseInstance(1.0, buffer.get(i).getCenter()),dim, tmpStamp, t, m);
        }
        initialized = true;
        Long t1= System.currentTimeMillis() - t0;
        initalTime += t1;
    ...
    public void trainOnInstanceImpl(Instance instance) {
        ...
        if ( minDistance < radius ) {
            ...
            //System.out.println("距离：" + minDistance + "," + "半径：" + radius);
    ...
    public ClustreamKernel[] getMicroClusteringResult1() {
        if (!initialized) {
