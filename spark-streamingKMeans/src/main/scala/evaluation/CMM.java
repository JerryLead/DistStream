...
import evaluation.CMM_GTAnalysis.CMMPoint;
...
public class CMM extends MeasureCollection {
    ...
    public String middleResultPath = "";
    ...
    public void evaluateClustering(Clustering clustering, Clustering trueClustering, ArrayList<DataPoint> points) throws Exception{
        ...
        System.out.println("start CMM_GTAnalysis");
        gtAnalysis = new CMM_GTAnalysis(trueClustering, points, enableClassMerge, middleResultPath);
        System.out.println("finish CMM_GTAnalysis");
        ...
        System.out.println("start calculateMatching");
        calculateMatching();
        System.out.println("finish calculateMatching");

        /* calculate the actual error */
        System.out.println("start calculateError");
        calculateError();
        System.out.println("finish calculateError");
    }
    ...
    private void calculateError(){
        ...
        System.out.println("CMM: " + ((totalErrorMax!=0)?1-totalError/totalErrorMax:1));
        System.out.println("CMM Missed: " + ((errorMissedMax!=0)?1-errorMissed/errorMissedMax:1));
        System.out.println("CMM Misplaced: " + ((errorMisplacedMax!=0)?1-errorMisplaced/errorMisplacedMax:1));
        System.out.println("CMM Noise: " + ((errorNoiseMax!=0)?1-errorNoise/errorNoiseMax:1));
        System.out.println("CMM Basic: " + (1-((double)totalErrorCount/(double)numPoints)));
