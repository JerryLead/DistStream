...
import denstream.DenStreamOnline
import denstreamwtihSort.{DenStreamOnlineWithSort, DenStreamOnlineWithSort1,DenStreamOfflineWithSort}
...
object DenstreamSort {
  ...
  //133.133.20.1:9092,133.133.20.2:9092,133.133.20.3:9092,133.133.20.4:9092,133.133.20.5:9092,133.133.20.6:9092,133.133.20.7:9092,133.133.20.8:9092
    ...
    var threshold = speedRate * (batchTime-3)
    //threshold = speedRate * (batchTime-4)
    ...
    val model = new DenStreamOnlineWithSort(numDimensions, 1000, batchTime)
