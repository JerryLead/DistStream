...
object ClustreamTime {
  ...
  def main(args: Array[String]) {
    ...
    val model = new CluStreamOnlineTime(q,numDimensions,0,batchTime)
    ...
    val clustream = new CluStreamTime(model)
